...
interface OutgoingTextMessageRouter {
    ...
    suspend fun send(roomId: String, peerUserId: String?, text: String, retry: Boolean): String?
}

object PlaintextOutgoingTextMessageRouter : OutgoingTextMessageRouter {
    override suspend fun send(roomId: String, peerUserId: String?, text: String, retry: Boolean): String? = null
}
