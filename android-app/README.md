...
- `android-app.test.live` 需要本机 Compose API 已启动，覆盖 Android 数据层注册、建群、双向文本互发和已读 smoke。
- `android-app.test.interop` 串联 `h5-app.test.live` 与 `android-app.test.live`，用于 H5/API/Android 聊天互通验收。
