...
printf '%s\n' '{}' >"$normal_dir/dist/security-headers.json"
printf '%s\n' 'fixture' >"$normal_dir/Caddyfile"
...
printf '%s\n' '{}' >"$preflight_dir/dist/security-headers.json"
printf '%s\n' 'fixture' >"$preflight_dir/Caddyfile"
...
for signal_case in "INT:130" "TERM:143"; do
  ...
  printf '%s\n' '{}' >"$signal_dir/dist/security-headers.json"
  printf '%s\n' 'fixture' >"$signal_dir/Caddyfile"
