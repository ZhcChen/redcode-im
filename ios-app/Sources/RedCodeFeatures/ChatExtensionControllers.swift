...
@MainActor
public final class EmojiStickerController: ObservableObject {
    @Published public private(set) var myPacks: [EmojiPack] = []
    @Published public private(set) var availablePacks: [EmojiPack] = []
    @Published public private(set) var searchResults: [EmojiPack] = []
...
@MainActor
public final class MessageSearchController: ObservableObject {
    @Published public private(set) var results: [MessageSearchDisplayResult] = []
...
@MainActor
public final class ChatSettingsController: ObservableObject {
    @Published public private(set) var background: ChatBackgroundPreference = .default
