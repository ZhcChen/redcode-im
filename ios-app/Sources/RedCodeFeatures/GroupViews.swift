...
public struct GroupSettingsView: View {
    ...
    @StateObject private var controller: GroupManagementController
...
public struct CreateGroupView: View {
    @ObservedObject private var authController: AuthController
    @ObservedObject private var contactsController: ContactsController
    @ObservedObject private var groupController: GroupManagementController
    ...
    public init(
        ...
        _authController = ObservedObject(wrappedValue: authController)
        _contactsController = ObservedObject(wrappedValue: contactsController)
        _groupController = ObservedObject(wrappedValue: groupController)
...
private struct AddGroupMembersView: View {
    @ObservedObject private var controller: GroupManagementController
    @ObservedObject private var authController: AuthController
    @ObservedObject private var contactsController: ContactsController
    let roomID: String
...
private struct GroupOperationLogsView: View {
    ...
    init(controller: GroupManagementController) {
        _controller = ObservedObject(wrappedValue: controller)
    }
