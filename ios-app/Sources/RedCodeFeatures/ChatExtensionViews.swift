...
public struct MessageSearchView: View {
    ...
    @StateObject private var controller: MessageSearchController
...
public struct ChatSettingsView: View {
    @ObservedObject private var authController: AuthController
    @StateObject private var settingsController: ChatSettingsController
    @StateObject private var stickerController: EmojiStickerController
    ...
    public init(
        ...
        _stickerController = StateObject(wrappedValue: stickerController)
    }
...
public struct ChatBackgroundSettingsView: View {
    @StateObject private var controller: ChatSettingsController
...
public struct StickerManagementView: View {
    @ObservedObject private var authController: AuthController
    @StateObject private var controller: EmojiStickerController
