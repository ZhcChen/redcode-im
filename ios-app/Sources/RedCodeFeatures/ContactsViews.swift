...
public struct ContactsHomeView: View {
    ...
    @StateObject private var contactsController: ContactsController
    @StateObject private var addFriendController: AddFriendController
    ...
    public init(
        ...
        _contactsController = StateObject(wrappedValue: contactsController)
        _addFriendController = StateObject(wrappedValue: addFriendController)
    }
    ...
    public var body: some View {
        ...
        .redcodeNavigationDestination(isPresented: activeChatPresented) {
            if let activeChat {
                ChatDetailView(
                    authController: authController,
                    chat: activeChat,
...
private struct AddFriendView: View {
    @ObservedObject private var authController: AuthController
    @ObservedObject private var addFriendController: AddFriendController
    ...
    init(
        ...
        _authController = ObservedObject(wrappedValue: authController)
        _addFriendController = ObservedObject(wrappedValue: addFriendController)
