...
@MainActor
@Observable
public final class NotificationNavigationController {
    public private(set) var pendingDestination: PushNavigationDestination?
...
@MainActor
@Observable
public final class PushController: ChatLocalNotificationService {
    public private(set) var notificationPermissionGranted = false
    public private(set) var registeredIdentity: StoredPushDeviceIdentity?
