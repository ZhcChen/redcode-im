...
public final class SettingsController {
    public private(set) var generalSettings: GeneralSettings?
    public private(set) var privacyPolicy: DocumentContent?
    public private(set) var userAgreement: DocumentContent?
    public private(set) var versionCheck: VersionCheckResult?
