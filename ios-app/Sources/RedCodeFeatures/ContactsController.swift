...
public final class ContactsController {
    public private(set) var contacts: [ContactSummary] = []
    public private(set) var pendingIncomingCount = 0
...
@MainActor
@Observable
public final class AddFriendController {
    public private(set) var searchResults: [AuthUser] = []
    public private(set) var incomingRequests: [FriendRequestInfo] = []
    public private(set) var outgoingRequests: [FriendRequestInfo] = []
