...
@MainActor
@Observable
public final class GroupManagementController {
    public private(set) var groups: [GroupSummary] = []
    public private(set) var currentGroup: GroupSummary?
    public private(set) var members: [RoomMember] = []
    public private(set) var settingsSnapshot: GroupSettingsSnapshot?
    public private(set) var admins: [GroupAdmin] = []
    public private(set) var mutes: [GroupMute] = []
    public private(set) var rules: [GroupRule] = []
    public private(set) var joinRequests: [GroupJoinRequest] = []
    public private(set) var operationLogs: [GroupOperationLog] = []
