  ...
  <Teleport to="body">
    ...
    >
      <div
        ...
        @click="handleAction('copy', canCopy)"
      >
      ...
      <div
        ...
        @click="handleAction('download', canDownload)"
      >
      ...
      <div
        ...
        @click="handleAction('delete', canDelete)"
      >
...
const handleAction = (action: 'copy' | 'download' | 'delete', enabled: boolean) => {
  if (!enabled) return
  emit(action)
