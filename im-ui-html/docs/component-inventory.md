...
| `Contact Profile` | 联系人身份区、操作条、关系信息带、资料列表与按需共同群聊 | `Online / Away / Busy / Shared Groups / No Shared Groups` | `ContactIdentity + action row + relationship strip + detail list` |
