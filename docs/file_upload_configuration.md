...
```bash
# 腾讯云COS配置
export COS_SECRET_ID="AKIDxxxxxxxxxxxxxxxxxxxxxx"
export COS_SECRET_KEY="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
export COS_REGION="ap-shanghai"
export COS_BUCKET="redcode-im-files"
export COS_ENDPOINT="cos.ap-shanghai.myqcloud.com"
...
.route("/users/me/avatar", patch(user::update_avatar))
