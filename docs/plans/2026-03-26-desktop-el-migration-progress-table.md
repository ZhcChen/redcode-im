...
| `P2-2` 媒体与输入体验收尾 | 部分完成 | `2026-03-26-desktop-el-voice-waveform-plan.md`、`2026-03-26-desktop-el-voice-post-edit-plan.md`、`2026-03-26-desktop-el-media-precache-plan.md`、`2026-03-26-desktop-el-image-preview-zoom-plan.md`、`2026-03-26-desktop-el-image-preview-rotation-plan.md`、`2026-03-26-desktop-el-image-preview-gallery-plan.md`、`2026-03-26-desktop-el-media-preview-keyboard-plan.md`、`2026-03-26-desktop-el-media-preview-save-plan.md`、`2026-03-26-desktop-el-video-preview-controls-plan.md`、`2026-03-26-desktop-el-video-preview-seek-plan.md` | `5533c672`、`615389de`、`c45f8e45`、`cc423e1e`、`db9d9ddb`、`2595b4ea`、`d1d27b5e` | 语音录制增强、更细视频预览 / 更细缓存治理 |
| `P2-3` 专属测试体系 | 部分完成 | `2026-03-26-desktop-el-electron-main-test-plan.md`、`2026-03-26-desktop-el-verification-entrypoint-plan.md`、`2026-03-26-desktop-el-app-ws-status-events-plan.md`、`2026-03-26-desktop-el-ws-connect-failure-status-plan.md` | `5e568d1c`、`e4c90eee`、`02228a85` | 更深 Go core 集成测试继续扩充、renderer smoke / e2e |
| `P2-4` 文档收口 | 已完成 | `2026-03-26-desktop-el-docs-closeout-plan.md` | `docs(desktop-el): close out migration planning docs` | 无 |

## 当前剩余优先项

1. `P2-2` 语音录制增强、更细视频预览与更细缓存治理。
2. `P0-1` 更细粒度消息管理增强项。
