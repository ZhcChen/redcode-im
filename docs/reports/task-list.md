...
- [ ] `IM2-U10` E2EE 发布门禁
  ...
  - G3.2/G3.3 的真实 Caddy/响应头/WebCrypto 能力证据有效，但 G4.1 重新打开
    ...
    已由 `22a728f9` 关闭；
    U7 P0-4 暂不维持关闭。
  - 当前执行顺序固定为 `U4.2 -> U4.3 -> U4.4 -> U5 -> U6 -> U7 -> U8 -> U9`；
    U1（`da3cead2`、`10f0f724`）、U2（`22a728f9`）、U3（`a644fa0f`）以及
    U4.1 隔离基础设施（`31b13d37`、`fe954a77`、`df85231b`）已完成。
    当前只执行 U4.2 candidate 到 restore 的同端口切换与恢复前历史密文证明；
    U4.3/U4.4 及后续单元不得提前并行打开。
