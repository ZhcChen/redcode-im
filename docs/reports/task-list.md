...
- 当前立即任务：继续 U8 的真实网络断开恢复、附件和完整页面巡检；双 iOS Patrol 编排、私聊双向已读、群聊实时互发及前后台离线消息恢复已通过。
...
- [ ] `IM2-U8` Flutter 移动 P0 设备验收收口
  ...
  - R1.3 已通过双 iOS 私聊双向已读、真实 UI 建群、群消息双向实时互发、前后台重连和离线文本消息恢复；待补真实网络切换、附件、群聊已读详情和群治理状态刷新。
