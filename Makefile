...
.PHONY: help status install.all test.all test.live tests.all dev.up dev.down dev.logs crg.build crg.update crg.status crg.review supply-chain.check supply-chain.test supply-chain.workflow.test \
	...
	e2ee-core.test e2ee-core.check e2ee-core.check.targets e2ee-core.test.flutter e2ee-core.test.wasm e2ee-core.fixture.generate e2ee.cross-client.live e2ee.cross-client.recovery.test e2ee.backup-drill.test e2ee.restore-compose.test \
