...
func (a *App) RegisterRPC() *rpc.Server {
	...
	server.Register("chat.group.leave", func(ctx context.Context, params json.RawMessage) (any, *rpc.RPCError) {
		var payload chat.RoomParams
		if err := unmarshalParams(params, &payload); err != nil {
			return nil, rpc.NewRPCError(rpc.ErrCodeInvalidParams, err.Error())
		}
		result, err := a.chat.LeaveGroup(ctx, payload)
		if err != nil {
			return nil, rpc.NewRPCError(rpc.ErrCodeInternal, err.Error())
		}
		return result, nil
	...
	server.Register("chat.group.dissolve", func(ctx context.Context, params json.RawMessage) (any, *rpc.RPCError) {
		var payload chat.RoomParams
		if err := unmarshalParams(params, &payload); err != nil {
			return nil, rpc.NewRPCError(rpc.ErrCodeInvalidParams, err.Error())
		}
		result, err := a.chat.DissolveGroup(ctx, payload)
		if err != nil {
			return nil, rpc.NewRPCError(rpc.ErrCodeInternal, err.Error())
		}
		return result, nil
	...
	server.Register("chat.pin", func(ctx context.Context, params json.RawMessage) (any, *rpc.RPCError) {
		var payload chat.PinMessageParams
		if err := unmarshalParams(params, &payload); err != nil {
			return nil, rpc.NewRPCError(rpc.ErrCodeInvalidParams, err.Error())
		}
		result, err := a.chat.PinMessage(ctx, payload)
		if err != nil {
			return nil, rpc.NewRPCError(rpc.ErrCodeInternal, err.Error())
		}
		return result, nil
	...
	server.Register("chat.unpin", func(ctx context.Context, params json.RawMessage) (any, *rpc.RPCError) {
		var payload chat.PinMessageParams
		if err := unmarshalParams(params, &payload); err != nil {
			return nil, rpc.NewRPCError(rpc.ErrCodeInvalidParams, err.Error())
		}
		result, err := a.chat.UnpinMessage(ctx, payload)
		if err != nil {
			return nil, rpc.NewRPCError(rpc.ErrCodeInternal, err.Error())
		}
		return result, nil
	...
	server.Register("chat.reactions.add", func(ctx context.Context, params json.RawMessage) (any, *rpc.RPCError) {
		var payload chat.MessageReactionParams
		if err := unmarshalParams(params, &payload); err != nil {
			return nil, rpc.NewRPCError(rpc.ErrCodeInvalidParams, err.Error())
		}
		result, err := a.chat.AddReaction(ctx, payload)
		if err != nil {
			return nil, rpc.NewRPCError(rpc.ErrCodeInternal, err.Error())
		}
		return result, nil
	...
	server.Register("chat.reactions.remove", func(ctx context.Context, params json.RawMessage) (any, *rpc.RPCError) {
		var payload chat.MessageReactionParams
		if err := unmarshalParams(params, &payload); err != nil {
			return nil, rpc.NewRPCError(rpc.ErrCodeInvalidParams, err.Error())
		}
		result, err := a.chat.RemoveReaction(ctx, payload)
		if err != nil {
			return nil, rpc.NewRPCError(rpc.ErrCodeInternal, err.Error())
		}
		return result, nil
	...
	server.Register("chat.reactions.list", func(ctx context.Context, params json.RawMessage) (any, *rpc.RPCError) {
		var payload chat.MessageReactionParams
		if err := unmarshalParams(params, &payload); err != nil {
			return nil, rpc.NewRPCError(rpc.ErrCodeInvalidParams, err.Error())
		}
		result, err := a.chat.ListReactions(ctx, payload)
		if err != nil {
			return nil, rpc.NewRPCError(rpc.ErrCodeInternal, err.Error())
		}
		return result, nil
	...
	server.Register("chat.edit", func(ctx context.Context, params json.RawMessage) (any, *rpc.RPCError) {
		var payload chat.EditMessageParams
		if err := unmarshalParams(params, &payload); err != nil {
			return nil, rpc.NewRPCError(rpc.ErrCodeInvalidParams, err.Error())
		}
		result, err := a.chat.EditMessage(ctx, payload)
		if err != nil {
			return nil, rpc.NewRPCError(rpc.ErrCodeInternal, err.Error())
		}
		return result, nil
